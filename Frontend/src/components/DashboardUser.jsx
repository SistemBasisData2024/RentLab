          ...
          items.map((item) => (
            <div key={item.id} className="border border-gray-300 rounded-lg p-4">
              ...
              <div className='w-full h-fit flex flex-col justify-between gap-2'>
                ...
                <button className='bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-400 text-xl'>Loan Item</button>
              </div>
            </div>
          ))
          :
