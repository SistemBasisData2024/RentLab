...
async function CreateBarang(req, res) {
  const { nama, lab_id, jumlah_total, image_url } = req.body;
  const jumlah_rent = 0;
  const jumlah_ketersediaan = jumlah_total;
  try {
    await pool.query("INSERT INTO barang (nama, lab_id, jumlah_total, image_url, jumlah_rent, jumlah_ketersediaan) VALUES ($1, $2, $3, $4, $5, $6)", [nama, lab_id, jumlah_total, image_url, jumlah_rent, jumlah_ketersediaan]);
